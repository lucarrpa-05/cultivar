---
id: math.topology.compactness.fixture-series-gap
...
weight: medium
angles: [tool]
tags: [fixture, series-gap]
series: {id: math.topology.fixture-arc, index: 1, total: 3, title: "Fixture arc"}
sources:
  - {title: "Compact space", type: wiki, url: "https://en.wikipedia.org/wiki/Compact_space"}
dates: {written: 2026-09-19}
author: lead
---
# A fixture series that never wrote episodes two and three

Compactness turns an infinite pile of local guarantees into one finite global statement, and that is the whole trick. You cover the space with open patches, and finitely many of them already do the job. The proof of the extreme value theorem uses nothing else, which is why the definition looks strange the first time you meet it and obvious the fifth.
